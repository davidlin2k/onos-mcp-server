...
from onos_mcp_server.api_client import ONOS_API_BASE, ONOS_USERNAME, ONOS_PASSWORD, HTTP_TIMEOUT
import os
import httpx
import tempfile
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            ...
            if not save_path:
                ...
                fd, save_path = tempfile.mkstemp(suffix='.tar.gz', prefix='onos_diagnostics_')
                os.close(fd)
