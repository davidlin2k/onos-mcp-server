...
async def get_port_statistics(deviceId: str, port: str) -> str:
    ...
    """
    try:
        statistics = await make_onos_request("get", f"/statistics/ports/{deviceId}/{port}")
        return str(statistics)
    except Exception as e:
...
async def get_device_delta_port_statistics(deviceId: str) -> str:
    ...
    """
    try:
        statistics = await make_onos_request("get", f"/statistics/delta/ports/{deviceId}")
        return str(statistics)
    except Exception as e:
...
async def get_port_delta_statistics(deviceId: str, port: str) -> str:
    ...
    """
    try:
        statistics = await make_onos_request("get", f"/statistics/delta/ports/{deviceId}/{port}")
        return str(statistics)
    except Exception as e:
...
async def get_link_flow_statistics(device: Optional[str] = None, port: Optional[str] = None) -> str:
    ...
    try:
        ...
        statistics = await make_onos_request("get", "/statistics/flows/link", params=params)
        return str(statistics)
    except Exception as e:
...
async def get_device_tables_statistics(deviceId: str) -> str:
    ...
    """
    try:
        statistics = await make_onos_request("get", f"/statistics/flows/tables/{deviceId}")
        return str(statistics)
    except Exception as e:
