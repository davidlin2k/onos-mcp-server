...
async def upload_network_configuration(config_data: Dict[str, Any]) -> str:
    ...
    """
    try:
        result = await make_onos_request("post", "/network/configuration", json=config_data)
...
async def get_subject_class_configuration(subject_class_key: str) -> str:
    ...
    """
    try:
        config = await make_onos_request("get", f"/network/configuration/{subject_class_key}")
        return str(config)
    except Exception as e:
        return f"Error retrieving configuration for subject class {subject_class_key}: {str(e)}"

async def upload_subject_class_configuration(subject_class_key: str, config_data: Dict[str, Any]) -> str:
    ...
    """
    try:
        result = await make_onos_request("post", f"/network/configuration/{subject_class_key}", json=config_data)
...
async def clear_subject_class_configuration(subject_class_key: str) -> str:
    ...
    try:
        ...
        return f"Configuration for subject class {subject_class_key} cleared successfully"
    except Exception as e:
...
async def get_subject_configuration(subject_class_key: str, subject_key: str) -> str:
    ...
    """
    try:
        config = await make_onos_request("get", f"/network/configuration/{subject_class_key}/{subject_key}")
        return str(config)
    except Exception as e:
        return f"Error retrieving configuration for subject {subject_key}: {str(e)}"

async def upload_subject_configuration(subject_class_key: str, subject_key: str, config_data: Dict[str, Any]) -> str:
    ...
    """
    try:
        result = await make_onos_request("post", f"/network/configuration/{subject_class_key}/{subject_key}", json=config_data)
        return f"Configuration for subject {subject_key} uploaded successfully: {result}"
    except Exception as e:
...
async def clear_subject_configuration(subject_class_key: str, subject_key: str) -> str:
    ...
    """
    try:
        await make_onos_request("delete", f"/network/configuration/{subject_class_key}/{subject_key}")
...
async def get_specific_configuration(subject_class_key: str, subject_key: str, config_key: str) -> str:
    ...
    """
    try:
        config = await make_onos_request("get", f"/network/configuration/{subject_class_key}/{subject_key}/{config_key}")
        return str(config)
    except Exception as e:
        return f"Error retrieving {config_key} configuration for subject {subject_key}: {str(e)}"

async def upload_specific_configuration(subject_class_key: str, subject_key: str, config_key: str, config_data: Dict[str, Any]) -> str:
    ...
    """
    try:
        result = await make_onos_request("post", f"/network/configuration/{subject_class_key}/{subject_key}/{config_key}", json=config_data)
...
async def clear_specific_configuration(subject_class_key: str, subject_key: str, config_key: str) -> str:
    ...
    """
    try:
        await make_onos_request("delete", f"/network/configuration/{subject_class_key}/{subject_key}/{config_key}")
        return f"{config_key} configuration for subject {subject_key} cleared successfully"
    except Exception as e:
