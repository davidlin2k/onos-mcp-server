...
async def get_device_port_modulation(device_id: str, port_id: str) -> str:
    ...
    try:
        ...
        modulation = await make_onos_request("get", f"/modulation/{device_id}/port", params=params)
...
async def set_port_modulation(device_id: str, port_id: str, direction: str, bitrate: float) -> str:
    ...
    try:
        ...
        result = await make_onos_request("put", f"/modulation/set-modulation/{device_id}", params=params)
