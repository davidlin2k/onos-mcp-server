...
async def create_region(region_id: str, region_name: str, region_type: str, masters: List[str] = None) -> str:
...
async def update_region(regionId: str, region_data: Dict[str, Any]) -> str:
    ...
    """
    try:
        result = await make_onos_request("put", f"/regions/{regionId}", json=region_data)
...
async def add_devices_to_region(regionId: str, device_ids: List[str]) -> str:
    ...
    try:
        ...
        result = await make_onos_request("post", f"/regions/{regionId}/devices", json=device_data)
...
async def remove_devices_from_region(regionId: str, device_ids: List[str]) -> str:
    ...
    try:
        ...
        await make_onos_request("delete", f"/regions/{regionId}/devices", json=device_data)
